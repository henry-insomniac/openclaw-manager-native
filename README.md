...
- browse, install, enable, disable, and configure local skills from a native UI
...
- [1.1.5](./docs/releases/1.1.5.md) 默认位 auth 池切成多账号运行池，补出运行 auth 可见性，并让最近限流账号暂时退避
- [1.1.4](./docs/releases/1.1.4.md) 修复全屏关闭黑屏，澄清认证时效展示，并补上未激活账号受控编辑
- [1.1.3](./docs/releases/1.1.3.md) Skills 市场详情超时 hotfix，并补上渐进展开结果列表
- [1.1.2](./docs/releases/1.1.2.md) Skills 市场切到 ClawHub，补齐粘贴、中文摘要和输入性能热修复
